...
function openWhatsApp() {
  ...
  const whatsappURL = `https://api.whatsapp.com/send?phone=${923018237855}&text=Hello! I'd like to chat.`;
...
function sendEmail() {
  ...
  const emailAddress = "sadiasadiq0341@gmail.com";
  ...
  const emailMessage = "Hello! I'd like to chat about my research";
...
function downloadCV() {
  ...
  anchor.download = "DiaaCV.pdf"; // Change the name of the downloaded CV file
  anchor.click();
}
